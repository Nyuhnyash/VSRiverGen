...
// {
//     public static void TesselateFlow(float[] upFlowVectors, TCTCache varsTwo)
//     {
...
//     [HarmonyPatch(nameof(LiquidTesselator.Tesselate))]
...
//                 new CodeInstruction(OpCodes.Call, AccessTools.Method(typeof(LiquidTesselatorPatch), nameof(TesselateFlow)))
//             };
//
//             if (insertionIndex != -1)
//             {
